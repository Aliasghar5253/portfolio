...
import { FaDownload, FaFacebook, FaGithub, FaLinkedin, FaInstagram } from 'react-icons/fa';
...
import Aliasghar from '../../../public/images/shabbir.jpg';
  ...
  return (
    <>
      ...
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <Image className='w-20 h-20 rounded-full' src={Aliasghar} alt='profile picture' />
